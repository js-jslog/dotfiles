...
alias blmg="cd ~/rsl/webapps/blmg_devt"
alias bndg="cd ~/rsl/webapps/bndg_devt"
alias ccfe="cd ~/rsl/webapps/ccfe_devt"
alias cptg="cd ~/rsl/webapps/cptg_devt"
alias edfe="cd ~/rsl/webapps/edfe_devt"
alias hnsn="cd ~/rsl/webapps/hnsn_devt"
alias rulg="cd ~/rsl/webapps/rulg_devt"
